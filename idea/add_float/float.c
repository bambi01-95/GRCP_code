...
// 2023.05.16
// 整数（int）に加えて、浮上小数点(float)の入力を可能にするために手を加えた
// 2023.05.17
// int とfloatで演算を行うと誤差が生まれてしまう。
//  ->pythonは入力桁数に制限はない
...
typedef enum { ILLEGAL, Undefined, Integer, Float, Symbol, Primitive, Special, Closure, Cell } type_t;
